...
complete_df = dengdf.iloc[0: -MAX_DELAY]
...
n_usable_obs = len(complete_df) - MAX_DELAY
...
train_df = complete_df.iloc[MAX_DELAY: train_end_idx]
val_df = complete_df.iloc[train_end_idx - MAX_DELAY : val_end_idx]
test_df = complete_df.iloc[val_end_idx - MAX_DELAY : ]
